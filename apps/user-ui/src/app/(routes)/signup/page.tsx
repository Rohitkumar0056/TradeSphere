            ...
            <div className='w-full flex justify-center'>
                <div className="md:w-[480px] p-8 bg-white shadow rounded-lg">
                    ...
                    {!showOtp ? (<form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <input type="text" placeholder='Rohit' className='w-full p-2 border border-gray-300 outline-0 !rounded mb-1'
                        {...register("name", 
                        ...
                        <button type='submit' disabled={signupMutation.isPending} className='w-full text-lg cursor-pointer mt-4 bg-black text-white py-2 rounded-lg'>
